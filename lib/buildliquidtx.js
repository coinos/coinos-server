...
const api = prod ? "https://blockstream.info/liquid/api" : "http://localhost:3002";
...
module.exports = async ({ address, asset, amount, feeRate, user }) => {
  ...
  if (!feeInput) throw new Error("Insufficient balance, couldn't find an input to cover the fee");
