...
(function() {
  var ADDRESS_FAIL, EXCHANGE_FAIL, SOCKET_FAIL, clear, fail, fetchExchangeRate, g, getAddress, listen, logTransaction, moment, multiplier, setup, updateTotal;
  ...
  setup = function() {
    var ext, src, _base, _base1, _base2, _base3, _base4;
    (_base = g.user).address || (_base.address = '');
    (_base1 = g.user).commission || (_base1.commission = 0);
    (_base2 = g.user).currency || (_base2.currency = 'CAD');
    (_base3 = g.user).symbol || (_base3.symbol = 'quadrigacx');
    (_base4 = g.user).unit || (_base4.unit = 'BTC');
    if (g.user.title) {
