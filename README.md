...
### Getting Started
    ...
    cp .env.sample .env
    cp fx.sample fx
    docker run -it -v /full/path/to/coinos-ui:/coinos-ui --entrypoint yarn asoltys/coinos-ui:dev
